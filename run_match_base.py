...
from my_custom_player_base import CustomPlayer
...
TEST_AGENTS = {
    ...
    "SELF": Agent(CustomPlayer, "CustomBase TestAgent")
}
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            ...
            - Run 100 rounds (100 rounds = 200 games) against the minimax agent with 1 process:
                ...
                $python run_match.py -r 100 -d -f action="store_true"
        """)
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '-l', '--log_file', type=str, default='matches.log',
        help="Set log_file."
    )
