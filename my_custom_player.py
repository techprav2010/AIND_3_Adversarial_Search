...
class CustomPlayer(DataPlayer):
    ...
    **********************************************************************
    ...
    def score_advanced(self, state):
        ...
        move_weight =  own_moves - opp_moves
        center_weight = (opp_center - own_center)
        if  ply_count > 15  or center_weight > 0.8 :
            center_factor =   abs(move_weight) * center_weight
        elif center_weight < -0.5 :
            center_factor = center_weight
        else:
            center_factor = 0
        return move_weight + center_factor
